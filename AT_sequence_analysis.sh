...
bedtools closest -io -iu -D a -a <(cat ${Organ}_AT_4tunitIntersectNativeHMM_intersectRegion_strain_temp1_SNP.bed| sort -k1,1 -k2,2n) -b P.CAST_M.B6_indelsNsnps_CAST.bam.alleleDBInput.snp.sorted.bed | uniq > ${Organ}_AT_4tunitIntersectNativeHMM_intersectRegion_strain_temp1_2SNP.bed
...
| awk 'BEGIN {OFS="\t";c="_SNP2"}($16+1 > 0 && $16+0 <20) {print $1, $13, $14, $4c, $5, $6 ,$10, $15, $16}'  \
